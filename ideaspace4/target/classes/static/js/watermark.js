function watermark(settings) {
    ...
    if (defaultSettings.watermark_id !== null && defaultSettings.watermark_id !== undefined) {
        page_width = document.getElementById(defaultSettings.watermark_id).clientWidth;
        page_height = document.getElementById(defaultSettings.watermark_id).clientHeight;
    }
    ...
    for (var i = 0; i < defaultSettings.watermark_rows; i++) {
        ...
        for (var j = 0; j < defaultSettings.watermark_cols; j++) {
            ...
            //禁止文字选中
            mask_div.style.webkitUserSelect = 'none';
